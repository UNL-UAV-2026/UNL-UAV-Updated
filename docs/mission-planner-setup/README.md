...
This guide walks new team members through installing Mission Planner and running a basic simulated flight (SITL) — no hardware required.
...
> ⚠️ **Windows only.** Mission Planner does not run natively on macOS. If you're on a Mac, let a team lead know — you'll need a Windows VM or an alternative workflow before continuing.
...
That's it — you've completed a basic simulated flight in Mission Planner. This is a good sandbox to keep experimenting in before working with real hardware.
